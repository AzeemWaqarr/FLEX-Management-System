...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="TextBox2" runat="server" style="margin-left: 51px"></asp:TextBox>
        <p>
        ...
        <asp:Button ID="Button1" runat="server" BackColor="Blue" BorderColor="Blue" BorderStyle="Inset" Font-Bold="True" Font-Underline="True" ForeColor="White" OnClick="Button1_Click" style="margin-left: 416px" Text="Register" Width="121px" />
    </form>
</body>
</html>
